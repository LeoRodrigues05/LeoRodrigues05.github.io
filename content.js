    ...
    researchInterests: [
        {
            ...
            icon: "👁️",
            description: "Interpret model behaviour emperically and reverse engineering model algorithms to infer model behaviour during various situations. Learn more at <a href='https://www.anthropic.com/news/mechanistic-interpretability' target='_blank'>Anthropic's Research</a>."
        },
        {
            title: "dvadva",
            icon: "🔬",
